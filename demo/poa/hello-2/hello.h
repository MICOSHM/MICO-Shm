...
template<class T>
class POA_HelloWorld_tie : 
  virtual public POA_Tie_Base<T>,
  virtual public POA_HelloWorld
{
  public:
    POA_HelloWorld_tie (T &t)
      : POA_Tie_Base<T> (&t, PortableServer::POA::_nil(), FALSE)
    {}
    POA_HelloWorld_tie (T &t, PortableServer::POA_ptr _poa)
      : POA_Tie_Base<T> (&t, _poa, FALSE)
    {}
    POA_HelloWorld_tie (T *t, CORBA::Boolean _rel = TRUE)
      : POA_Tie_Base<T> (t, PortableServer::POA::_nil(), _rel)
    {}
    POA_HelloWorld_tie (T *t, PortableServer::POA_ptr _poa, CORBA::Boolean _rel = TRUE)
      : POA_Tie_Base<T> (t, _poa, _rel)
    {}
    virtual ~POA_HelloWorld_tie ();
  ...
  private:
    POA_HelloWorld_tie (const POA_HelloWorld_tie<T> &);
    void operator= (const POA_HelloWorld_tie<T> &);
};

template<class T>
POA_HelloWorld_tie<T>::~POA_HelloWorld_tie ()
{
}

template<class T>
PortableServer::POA_ptr
POA_HelloWorld_tie<T>::_default_POA ()
{
...
template<class T>
void
POA_HelloWorld_tie<T>::hello ()
{
  POA_Tie_Base<T>::ptr->hello ();
}
